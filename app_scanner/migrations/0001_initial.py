...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('risk_level', models.CharField(choices=[('A', 'Healthy'), ('B', 'Low'), ('C', 'Medium'), ('D', 'High')], verbose_name='Risk level')),
                ('review', models.JSONField(verbose_name='Review')),
                ('review_file_path', models.FilePathField(blank=True, path='/home/alvin/projects/djangoScannerXSS/media/reviews', verbose_name='File review')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('S', 'Started'), ('E', 'Error'), ('C', 'Completed')], verbose_name='Status')),
                ('result', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_scanner.scanresult', verbose_name='Result')),
